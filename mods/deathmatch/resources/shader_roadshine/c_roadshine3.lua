...
addEventHandler( "onClientResourceStart", resourceRoot,
	function()
		triggerEvent( "switchRoadshine3", localPlayer, false )
	end
)
...
function switchRoadshine3( bOn )
	outputDebugString( "switchRoadshine: " .. tostring(bOn) )
	if bOn then
		enableRoadshine3()
	else
		disableRoadshine3()
...
addEventHandler( "switchRoadshine3", localPlayer, switchRoadshine3 )
