...
addEvent( "openPicker", true )
addEventHandler( "openPicker", localPlayer, openPicker )
...
function colorPicker.create(id, start, title)
  ...
  cp.gui.okb = guiCreateButton(336, 235, 64, 24, "Gotowe", false, cp.gui.window)
  cp.gui.closeb = guiCreateButton(336, 265, 64, 24, "Zamknij", false, cp.gui.window)
...
-- test triggerEvent("onColorPickerOK", root, self.id, self.color.hex, self.color.r, self.color.g, self.color.b)
function onColorPick (id, hex, r, g, b)
  triggerServerEvent("pickerUpdateColor", getRootElement(), id, hex, r, g, b)
end
addEventHandler("onColorPickerChange", localPlayer, onColorPick)

function onColorPickApply(id, hex, r, g, b)
  triggerServerEvent("pickerClose", getRootElement(), id, hex, r, g, b)
end
addEventHandler("onColorPickerOK", localPlayer, onColorPickApply)